...
[Initial optimization results](optimization-results.md) summarize that stage;
[the implementation explanation](codec-optimization.md) describes the changes.
The [performance wrap-up](performance-plan.md) links subsequent decisions and
the [latest opt-out comparison](validation-opt-out-results.md).
