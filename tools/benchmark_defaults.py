...
def main():
    ...
    subprocess.run(["mojo", "build", "-O3", "-I", "src", "tools/packed_worker.mojo", "-o", str(binary)], cwd=ROOT, check=True)
    arms = {
